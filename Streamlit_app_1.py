...
# User input for warehouse coordinates
with st.expander("📍 Enter Warehouse Location"):
    warehouse_lat = st.number_input("Warehouse Latitude", value=14.08397, format="%.6f")
    warehouse_lon = st.number_input("Warehouse Longitude", value=79.794420, format="%.6f")
warehouse = ('Warehouse', warehouse_lat, warehouse_lon)

# Select biomass type and tractor capacity
